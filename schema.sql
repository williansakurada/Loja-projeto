SET NAMES utf8mb4;
-- os acentos nos produtos vão lidos normal
...
-- View principal: catálogo limpo e estruturado
...
-- se tentar salvar um preço/estoque negativo, o valor é convertido para positivo automático
